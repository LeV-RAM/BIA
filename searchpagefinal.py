...
"}")
        ...
        self.BinusLogo_2.setPixmap(QtGui.QPixmap(":/logo/assets/binuslogo.jpg"))
...
"}")
        ...
        self.BinusGambar.setPixmap(QtGui.QPixmap(":/logo/assets/login2.jpg"))
...
"padding-bottom:10px;")
        ...
        self.HomeButton.clicked.connect(SearchWindow.close)
...
"padding-bottom:10px;")
        ...
        self.SignOutButton.clicked.connect(SearchWindow.close)
...
"")
        ...
        self.recButton.clicked.connect(self.recommend_internship)
        self.recButton.clicked.connect(SearchWindow.close)
...
"}")
    ...
    def retranslateUi(self, SearchWindow):
        ...
        self.HomeButton.setText(_translate("SearchWindow", "HOME"))
        self.SearchButton.setText(_translate("SearchWindow", "SEARCH"))
        self.SignOutButton.setText(_translate("SearchWindow", "Sign Out"))
        self.recLabel.setText(_translate("SearchWindow", "Gives internship program recommendations based on your profile"))
        self.recButton.setText(_translate("SearchWindow", "RECOMMEND MY INTERNSHIP PROGRAMS"))
        self.binusUniversity.setText(_translate("SearchWindow", "2023 BINUS University"))
        self.binusMaya.setText(_translate("SearchWindow", "BINUSMAYA"))
import test_rc
